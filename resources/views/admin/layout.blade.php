            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd style="text-align: center;"><a href="javascript:;" id="showPassword">修改密码</a></dd>
                        <hr>
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    <li data-name="home" class="layui-nav-item layui-nav-itemed">
                        <a lay-href="{{route('admin.index')}}" lay-tips="主页" class="layui-this">
...
<script>
    ...
    //长时间未操作退出登录
    window.maxTime = 3*60*60; // seconds
    window.time = maxTime;
    ...
    function ShowInvalidLoginMessage() {
        ...
        layer.open({
            ...
            ,content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">已超过3小时无操作，请重新登录</div>'
